...
if(await data.fetch(`slm.${message.author.id}.${message.guild.id}.g`)) return message.inlineReply(new Discord.MessageEmbed().setColor('#00001').setDescription(`**10 saniyenin altında hızlı kullanamazsın!**`));
