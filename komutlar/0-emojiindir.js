                    ...
                    message.guild.emojis.cache.forEach(async emoji => {
                        const timeout = setTimeout(async () => {
                            ...
                            if (kalan == 0) {
                                ...
                                file.addLocalFolder('./emojiler', ' By DarkPlace');
                                fs.writeFileSync('/DarkPlace.zip', file.toBuffer());
                                ...
                                message.channel.send({
                                    files: [{ name: 'DarkPlaceX.zip', attachment: '/DarkPlace.zip' }]
                                }).then(() => {
...
exports.help = {
    name: 'emoji-indir',
    description: 'emoji indirme sistemi.'
};
