...
if(!args[0]) {
message.inlineReply(`**İpucu** — ${i[Math.floor(Math.random() * i.length)]}`);
const emojis = [];
...
message.inlineReply(`⚠️ Emojileri hareketli mi hareketsiz mi istediğinizi anlayamadığım için istediğiniz sayıda karışık şekilde gönderiyorum.
