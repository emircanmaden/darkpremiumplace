...
exports.run = (client, message, args) => { 
  let apikey = "UIP2RYM82XC3"//NOT KISMINI OKU!
 ...
 if(!sexdiyorum) return message.inlineReply("neyi arıcaksın?")
let halilazdım = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())
  .setTitle("İşte gifin")
  .setDescription(`**Gif id ${json.results[0].id}**`)
  ...
  .setColor('BLACK')
message.inlineReply(halilazdım)    
  })
  };
exports.conf = {
  enabled: true,  
