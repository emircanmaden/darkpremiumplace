...
exports.run = async (client, message, args) => {
    unit = args[0]
    if (!unit) return message.inlineReply("Lütfen bir crypto para belirtiniz. \`!crypto bitcoin\`")
    message.inlineReply(new Discord.MessageEmbed().setDescription('Bilgiler getiriliyor. Lütfen bekleyiniz..')).then(async m => {
