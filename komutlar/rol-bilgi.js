...
exports.run = async (bot, message, args) => {
    ...
    if (!role) return message.inlineReply('Rol girmelisin!')
    try {
    ...
    message.inlineReply(embed)
        ...
        message.inlineReply('Rol bulunamadı lütfen girdiğiniz bilgilerin doğru olduğundan emin olunuz.')
    }
};
exports.conf = { enabled: true, guildOnly: false, aliases: [], userPerms: [], clientPerms: ["EMBED_LINKS"] };
exports.help = { name: "rolbilgi", description: "Belirtilen rolün bilgilerini gösterir.", usage: "rolbilgi [ rol/id ]" };